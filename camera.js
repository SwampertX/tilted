...
import {
  ...
  showCurrentMotionName,
} from './demo_util';

let updateRestPose = true;
let restPose = {
  ...
  async function poseDetectionFrame() {
    ...
    poses.forEach(({score, keypoints}) => {
      if (score >= minPoseConfidence) {
        ...
        // console.log(hasTiltedLeft({score, keypoints}));
      }
    });
    ...
    if (updateRestPose) {
      restPose = poses[0];
      updateRestPose = false;
    }
    showCurrentMotionName(poses[0], restPose);
